        ...
        <div class="card-header bg-transparent pb-5">
            ...
            <div class="text-center">
                <a href="#" class="btn btn-neutral btn-icon mr-4">
                    <span class="btn-inner--icon"><img src="{{ asset('argon-dashboard-master/assets/img/icons/common/github.svg') }}"></span>
                    <span class="btn-inner--text">Github</span>
                </a>
                <a href="#" class="btn btn-neutral btn-icon">
                    <span class="btn-inner--icon"><img src="{{ asset('argon-dashboard-master/assets/img/icons/common/google.svg') }}"></span>
